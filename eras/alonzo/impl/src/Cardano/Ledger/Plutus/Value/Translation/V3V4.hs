...
import Cardano.Ledger.Mary.Mint (Forging, unForging)
...
fromLedgerForging :: Forging -> PV3.MintValue
fromLedgerForging = PV3.UnsafeMintValue . PV1.getValue . PlutusValue.fromLedgerMultiAsset . unForging
